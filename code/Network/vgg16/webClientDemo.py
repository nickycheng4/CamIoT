...
#name-uclahci-lemur
applianceDict= {
	1 : ("Coffee Maker","192.168.0.249","0"),
	2 : ("TV","192.168.0.101","0"),
	3 : ("Printer","192.168.0.148","0"),
	4 : ("PC","192.168.0.162","0"),
	5 : ("Door","192.168.0.134","0"),
	6 : ("Lamp","192.168.0.206","192.168.1.59"),
}
