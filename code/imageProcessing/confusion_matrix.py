...
gt=[]
pd = []
wb = openpyxl.load_workbook(filename= "Data_Collection/05-13-19.xlsx", read_only=False, keep_vba=True)
sheet = wb.active
...
class_names = ['tv','printer','monitor', 'light', 'coffee maker']
class_names.sort()
