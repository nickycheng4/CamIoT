...
def fingerFinderFF(image):
	...
	#cv2.imshow("floodfill",irFF)
	by,bx=FingerBottom(irFF) #pass in the floodfilled image to find the finger bottom 
	bx=int(bx)
	#print("bx= " + str(bx))
	#print("by= " + str(by))
	...
	#cv2.imshow("Arrow",ir)
	#cv2.imwrite("arrows/arrowDirection1ff.jpg",ir)
	#cv2.waitKey(0)
	# find the white area of the finger 

#cv2.imshow("test",fingerFinderFF("ir.jpg"))
#cv2.waitKey(0)	
#imagediff()
#image_bright()
#floodfill()
